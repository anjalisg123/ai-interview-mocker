...
//     useEffect(() => {
//         // 3. Use the unwrapped variable, NOT 'params' directly
//         GetFeedback();
...
//             .from(UserAnswer)
//             .where(eq(UserAnswer.mockIdRef, unwrappedParams.interviewId)) // Use unwrappedParams here
...
//             <h2 className='font-bold text-xl text-gray-500'>No Feedback Available</h2>
//                 :
//             <>
...
function Feedback({ params }) {
    ...
    // 1. Iterate through the feedback list
    // 2. Convert rating string to a number (e.g., "5" -> 5)
    // 3. Sum them up and divide by the total count
    const overallRating = feedbackList && feedbackList.length > 0
